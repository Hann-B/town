...
namespace town
{
    class School
    {
        ...
        {
            var teacherStudentRatio = GCD(this.NumberOfTeachers, this.NumberOfStudents);
            return string.Format($"{this.NumberOfTeachers / teacherStudentRatio}:{this.NumberOfStudents / teacherStudentRatio}");
            int GCD(int a, int b)
            {
